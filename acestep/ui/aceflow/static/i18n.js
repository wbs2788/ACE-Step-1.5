(function () {
  ...
  const I18N = {
    en: {
      ...
      'help.cover_noise_strength': 'Controls how closely Remix or Cover stays tied to the reference audio during noising/denoising. Lower values allow more deviation and reinterpretation; higher values keep the result closer to the source audio. Recommended for SFT: 0.10–0.25. (0 = very loose / near-pure noise, 1 = closest to the original audio).',
    ...
    it: {
      ...
      'help.cover_noise_strength': "Controlla quanto Remix o Cover restano legati all'audio di riferimento durante noising/denoising. Valori bassi lasciano più libertà e reinterpretazione; valori alti mantengono il risultato più vicino alla sorgente. Consiglio per SFT: 0.10–0.25. (0 = molto libero / quasi rumore puro, 1 = più vicino all'audio originale).",
